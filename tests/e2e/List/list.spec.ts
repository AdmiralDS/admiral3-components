...
test.describe('List playground', () => {
  ...
  test('supports item value in native and CSS counters', async ({ page }) => {
    await page.goto(getPlaygroundScenarioPath('list/item-value'));

    await expect(page.getByTestId('ordered-value-list')).toHaveCSS('counter-reset', 'admiral-list-counter 0');
